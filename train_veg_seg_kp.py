...
argp.add_argument("--save-interval",type=int,default=50,help="Epochs after whcih to save a checkpoint")
argp.add_argument("--save-path",type=str,default="/home/ec2-user/SageMaker/SMN/weights/seg_key/",help="Epochs after which to save a checkpoint")
argp.add_argument("--lr",type=float,default=1e-3,help="Learning rate")
argp.add_argument("--epochs",type=int,default=1000,help="Maximum Epochs to train")
...
argp.add_argument("--pretrain",type=str,default="/home/ec2-user/SageMaker/SMN/weights/seg_key_pretrain_1/50_epoch_weights",help="Pretrain weights")
...
def build_model(config):
    model = vegnet_resnet50_fpn(pretrained=True,trainable_backbone_layers=1,num_classes=config["numclasses"],class_map=config["classes"],num_keypoints=config["keypoints"]["num"],kp_name=config["keypoints"]["name"],
...
if __name__=="__main__":
    ...
    det_train="/home/ec2-user/SageMaker/SMN/data/seg_kp/seg"
    kp_train="/home/ec2-user/SageMaker/SMN/data/seg_kp/kp"
    ...
    for epoch in tqdm(range(num_epochs+2)):
        ...
        logs,targetloss=train_one_epoch_seg_kp(model, device, epoch, print_freq=5,optim=optim,dataloaders=data_loaders,prevlog=prevlog,warmup=30)
