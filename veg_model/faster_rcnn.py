...
class FasterRCNN(GeneralizedRCNN):
    ...
    def __init__(self, backbone, num_classes=None,
                 ...
                 # class names for specific branches
                 kp_name=None,
        ...
        # Pass the segm_names to resize 
        transform = GeneralizedRCNNTransform(min_size, max_size, image_mean, image_std,segm_names=segm_names)
